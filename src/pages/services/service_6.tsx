...
import img from "../../images/services/pages/marble/marble.png";
const Service_6 = () => {
  const data = {
    banner: {
      mainTitle: "جلى الرخام",
      subTitle: "افضل شركة لـ جلى الرخام",
    },
    pageTitle: {
      title: "خدماتنا | جلي الرخام",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في خدمة جلى الرخام",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات شركتنا في خدمة جلي و تلميع الرخام",
      paragraphs: [
        {
