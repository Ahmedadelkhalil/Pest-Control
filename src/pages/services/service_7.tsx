...
import img from "../../images/services/pages/restaurants/restaurants.png";

const Service_7 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف هود المطاعم",
      subTitle: "افضل شركة لـ تنظيف هود المطاعم",
    },
    pageTitle: {
      title: "خدماتنا | هود المطاعم",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في تنظيف مداخن المطاعم",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات شركتنا في خدمة تنظيف مداخن المطاعم",
      paragraphs: [
        {
