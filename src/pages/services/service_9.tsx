...
import img from "../../images/services/pages/insects/insects.jpg";

const Service_9 = () => {
  const data = {
    banner: {
      mainTitle: "مكافحة الحشرات",
      subTitle: "افضل شركة لـ مكافحة الحشرات و القوارد",
    },
    pageTitle: {
      title: "خدماتنا | مكافحه الحشرات",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في مكافحة الحشرات",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات شركتنا في خدمة مكافحة الحشرات",
      paragraphs: [
        {
