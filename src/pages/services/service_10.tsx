...
import img from "../../images/services/pages/afterFinishing/afterFinishing.jpg";

const Service_10 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف ما بعد التشطيب",
      subTitle: "افضل شركة لـ تنظيف ما بعد التشطيب",
    },
    pageTitle: {
      title: "خدماتنا | ما بعد التشطيب",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في خدمة تنظيف ما بعد التشطيب",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات شركتنا في خدمة خدمة تنظيف ما بعد التشطيب",
      paragraphs: [
        {
