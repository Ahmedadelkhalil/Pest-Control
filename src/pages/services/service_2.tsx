...
import img from "../../images/services/pages/furniture/furniture.jpg";

const Service_2 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف الاثاث",
      subTitle: "افضل شركة لـ تنظيف الاثاث",
    },
    pageTitle: {
      title: "خدماتنا | الاثاث",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في خدمة تنظيف الاثاث",
      percentages: [
        {
