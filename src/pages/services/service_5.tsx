...
import img from "../../images/services/pages/companies/company.jpg";

const Service_5 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف الشركات",
      subTitle: "افضل شركة لـ تنظيف الشركات",
    },
    pageTitle: {
      title: "خدماتنا | الشركات",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في خدمة تنظيف الشركات",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات خدمة تنظيف اثاث المنازل",
      paragraphs: [
        {
