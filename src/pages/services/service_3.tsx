...
import img from "../../images/services/pages/surfaces/surface.png";

const Service_3 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف الواجهات",
      subTitle: "افضل شركة لـ تنظيف الواجهات",
    },
    pageTitle: {
      title: "خدماتنا | الواجهات",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في خدمة نظافة الواجهات",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات شركتنا في خدمة تنظيف الواجهات",
      paragraphs: [
        {
