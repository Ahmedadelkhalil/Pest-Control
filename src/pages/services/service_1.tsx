...
import img from "../../images/services/pages/carpet/carpet.jpg";

const Service_1 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف السجاد والموكيت",
      subTitle: "افضل شركة لـ تنظيف السجاد والموكيت",
    },
    pageTitle: {
      title: "خدماتنا | السجاد و الموكيت",
    },
    sec_1: {
      mainTitle:
        "لماذا يمكنك الاعتماد علي شركتنا في خدمة نظافة السجاد والموكيت",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات خدمة نظافة السجاد والموكيت",
      paragraphs: [
        {
