...
import img from "../../images/services/pages/houses/house.jpg";

const Service_4 = () => {
  const data = {
    banner: {
      mainTitle: "تنظيف الشقق و الفيلات",
      subTitle: "افضل شركة لـ تنظيف الشقق و الفيلات",
    },
    pageTitle: {
      title: "خدماتنا | الشقق و الفيلات",
    },
    sec_1: {
      mainTitle: "لماذا يمكنك الاعتماد علي شركتنا في خدمة تنظيف المنزل",
      percentages: [
        {
    ...
    sec_2: {
      mainTitle: "مميزات شركتنا في خدمة نظافة الشقق والفيلات",
      paragraphs: [
        {
